...
import AppleColor from "./assets/AppleColor.png";
import Spaceman from "./assets/spaceman.png";

function LogInPage({ handleBackClick, handleLogin }) {
  return (
    <div className="flex flex-col lg:flex-row h-screen">
      {/* Left Section */}
      <div className="flex-1 flex flex-col justify-center px-6 lg:px-20 bg-white">
        <div className="max-w-xl w-full mx-auto">
          <h3 className="text-gray-600 text-lg font-medium mb-2 kanit-semibold">
            Start your Journey
          </h3>
          <h2 className="text-3xl text-purpleCustom mb-6 kanit-semibold font-bold">
            LogIn to BitpointX
          </h2>
          ...
          {/* Log In Button */}
          <button className="w-full rounded-lg text-white font-bold py-2 px-6 bg-gradient-to-r from-purpleCustom to-pinkCustom hover:opacity-90 transition duration-300">
            Log In
          </button>
          ...
          <div className="flex justify-center space-x-6">
            ...
            <div className="w-12 h-12 border border-gray-300 rounded-full flex items-center justify-center">
              <img src={GoogleColor} alt="Google" />
            </div>
            <div className="w-12 h-12 border border-gray-300 rounded-full flex items-center justify-center">
              <img src={AppleColor} alt="Apple" />
            </div>
          </div>
      ...
      {/* Right Section */}
      <div className="hidden lg:flex flex-1 relative justify-center items-center h-full">
        <img
          src={Spaceman}
          alt="Astronaut"
          className="h-full float-animation"
        />
      </div>
    </div>
  );
